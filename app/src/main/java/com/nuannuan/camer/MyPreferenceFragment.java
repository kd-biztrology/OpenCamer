...
public class MyPreferenceFragment extends PreferenceFragment
  ...
  @Override public void onCreate(Bundle savedInstanceState) {
    ...
    if (!supports_face_detection) {
      ...
      PreferenceGroup pg =
          (PreferenceGroup) this.findPreference("preference_category_camera_effects");
    ...
    if (widths != null && heights != null) {
      ...
      for (int i = 0; i < widths.length; i++) {
        entries[i] =
            widths[i] + " x " + heights[i] + " " + Preview.getAspectRatioMPString(widths[i],
                heights[i]);
          ...
          if (pref.getKey().equals("preference_about")) {
            ...
            about_string.append(Locale.getDefault().getLanguage());
            {
              ActivityManager activityManager =
                  (ActivityManager) getActivity().getSystemService(Activity.ACTIVITY_SERVICE);
              about_string.append("\nStandard max heap?: ");
            ...
            }
            {
              ...
              Display display =
                  MyPreferenceFragment.this.getActivity().getWindowManager().getDefaultDisplay();
