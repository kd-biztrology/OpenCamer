...
public class PopupView extends LinearLayout {
  ...
  public PopupView(Context context) {
    ...
    if (preview.isVideo() && preview.isTakingPhoto()) {
          ...
          "PHOTO_RESOLUTIONS", new ArrayOptionsPopupListener() {
            ...
            private void update() {
              ...
              SharedPreferences sharedPreferences =
                  PreferenceManager.getDefaultSharedPreferences(main_activity);
              SharedPreferences.Editor editor = sharedPreferences.edit();
              editor.putString(PreferenceKeys.getResolutionPreferenceKey(preview.getCameraId()),
                  resolution_string);
              editor.apply();
          ...
          false, video_size_index, false, "VIDEO_RESOLUTIONS", new ArrayOptionsPopupListener() {
            ...
            private void update() {
              ...
              SharedPreferences sharedPreferences =
                  PreferenceManager.getDefaultSharedPreferences(main_activity);
              SharedPreferences.Editor editor = sharedPreferences.edit();
              editor.putString(PreferenceKeys.getVideoQualityPreferenceKey(preview.getCameraId()),
                  quality);
              editor.apply();
      ...
      String grid_value = sharedPreferences.getString(PreferenceKeys.getShowGridPreferenceKey(),
      ...
      if (use_scrollview) {
        ...
        scroll.addView(ll2);
        {
          ViewGroup.LayoutParams params =
              new LayoutParams((int) (total_width * scale + 0.5f), // convert dps to pixels
